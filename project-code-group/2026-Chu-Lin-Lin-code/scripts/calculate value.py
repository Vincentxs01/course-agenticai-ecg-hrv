...
def run_one(config_path: Path, outdir: Path, win_sec: int, overlap: float, k_rest: float, k_active: float):
    """
    Call scripts/comprehensive_comparison.py programmatically by setting sys.argv and invoking main().
    """
    from scripts.comprehensive_comparison import main as dataset_main
